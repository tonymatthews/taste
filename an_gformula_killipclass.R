...
write.table(results_1y, paste0("logfiles/an_gformula_allmodels_killipsens_", period, ".txt"), sep="\t", quote=FALSE, row.names=FALSE)
write.table(difference_results_1y, paste0("logfiles/an_gformula_rddiff_killipsens_", period, ".txt"), sep="\t", quote=FALSE, row.names=FALSE)
